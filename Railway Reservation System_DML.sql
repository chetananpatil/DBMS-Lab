...
INSERT INTO USER VALUES('U1','UT1','CHETANA','PATIL',20,11,'SN01','2002-11-17');
INSERT INTO USER VALUES('U2','UT2','CHAITRA','PATIL',20,12,'SN02','2002-09-22');
INSERT INTO USER VALUES('U3','UT3','GIRIJA','MELMALGI',18,13,'SN03','2004-11-18');
INSERT INTO USER VALUES('U4','UT4','PRASHANT','MELMALGI',19,14,'SN04','2003-05-09');
INSERT INTO USER VALUES('U5','UT5','JYOTI','KAMATI',15,16,'SN05','2007-02-27');
INSERT INTO USER VALUES('U6','UT6','KUMARI','SHIVANGI',17,19,'SN06','2005-04-15');
SELECT * FROM USER;
...
INSERT INTO TICKET_PASSENGER values('SN01','chetana',20,'pnr1');
INSERT INTO TICKET_PASSENGER values('SN02','chaitra',20,'pnr2');
INSERT INTO TICKET_PASSENGER values('SN03','GIRIJA',18,'PNR3');
INSERT INTO TICKET_PASSENGER values('SN04','PRASHANT',19,'PNR4');
INSERT INTO TICKET_PASSENGER values('SN05','JYOTI',15,'PNR5');
INSERT INTO TICKET_PASSENGER values('SN06','SHIVANGI',17,'PNR6');
...
create user chetana@localhost identified by 'Chetu@12';
GRANT SELECT, INSERT, UPDATE, DELETE ON route_info TO 'chetana'@'localhost';
grant select on *.* to chetana@localhost;
GRANT ALL ON train TO 'chetana'@'localhost';
REVOKE DELETE, UPDATE ON train FROM 'chetana'@'localhost';
REVOKE ALL ON train from 'chetana'@'localhost';
SET autocommit=0 | 1;
revoke update on *.* from chetana@localhost;
revoke delete on *.* from chetana@localhost;
SAVEPOINT SP1;
